    ...
    class Program
    {
        public class Peli_tila {
            ...
            public string näytä_tila()
            {
                ...
                Console.Write("\n");
                Console.WriteLine("DEBUG-koodia:");
                Console.WriteLine("Syötit merkin:" + valinta);
                foreach (string arvo in siirtymätilat)
                {
        ...
        static void Main(string[] args)
        {
            ...
            string seuraavava_tila = alku.näytä_tila();
            Console.WriteLine("Seuraavaksi pitäisi siirtyä tilaan:" + seuraavava_tila);
